    ...
    <div className="gidam">
      ...
      <div className="gidam-container">
        <div className="gidam-container-items">
          ...
          <p id="text3">
            교실은 시간의 잊혀진 흔적들로가득 차 있다. 교탁 위에는 오랜 세월을
            지나 비어버린 책과 노트, 그리고 어느 누가 잊고 간 물건들이 놓여져
            있다.
          </p>
          <p id="text4">
            잊혀진 교실 안에는 과거의 목소리가 여전히 울린다. 그 소리는 끊임없이
            되풀이되며, 당신을 인도하려는 것 같다.
          </p>
          <p id="text5">
            복도를 걸을 때마다, 어둠은 당신을 휘감는다. 어둠의 끝에서 당신이
            찾게 될 것은, 이 곳의 진실과 그 안에 감춰진 비밀이다.
          </p>
          <p id="text6">
            학교는 언제나 당신을 기다리고 있다. 그곳에서 당신은 시험할 것이다.
          </p>
